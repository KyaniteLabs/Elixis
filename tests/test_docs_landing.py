...
class TestDocsLanding(unittest.TestCase):
    ...
    def test_live_landing_exposes_auditable_trace_surface(self):
        ...
        self.assertIn("Synthesized Threads", html)
        self.assertIn("cross_domain_thread_count", html)
        self.assertIn("trace.pattern_matching?.threads", html)
        self.assertIn("trace-value-strong", html)
        self.assertIn("outputVisual", parser.ids)
        self.assertIn("outputSource", parser.ids)
        self.assertIn("renderOutputArtifacts", html)
        self.assertIn("color-swatch", html)
        self.assertIn("type-specimen", html)
        self.assertIn("radius-demo", html)
        self.assertIn("shadow-demo", html)
