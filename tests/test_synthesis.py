"""Tests for fugax.synthesis — SOUL.md template synthesis and helpers."""

from unittest.mock import patch

from fugax.synthesis import (
...
class TestTemplateSynthesize:
    ...
    def test_includes_footer(self):
        ...
        graph = _make_graph()
        result = _template_synthesize(entities, graph)
        assert "Generated by Fugax" in result
...
class TestSynthesizeSoulmd:
    @patch("fugax.synthesis.llm_available", return_value=False)
    ...
    @patch("fugax.synthesis.llm_available", return_value=True)
    @patch("fugax.synthesis._llm_synthesize")
...
class TestSynthesizeSoulmdStream:
    ...
    @patch("fugax.synthesis.llm_available", return_value=True)
    @patch("fugax.synthesis.chat_stream")
