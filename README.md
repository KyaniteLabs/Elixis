...
**What is Elixis?**
Elixis is a companion tool for the OpenClaw ecosystem that transforms brain dump text into structured SOUL.md identity documents for AI agents.
...
Soul Spec is an open standard for AI agent personas. Elixis generates SOUL.md documents compatible with Soul Spec v0.5, OpenClaw, and any framework that reads markdown-based identity files.
