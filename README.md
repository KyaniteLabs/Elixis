...
[![CI](https://github.com/KyaniteLabs/Fugax/actions/workflows/ci.yml/badge.svg)](https://github.com/KyaniteLabs/Fugax/actions/workflows/ci.yml)
[![GitHub stars](https://img.shields.io/github/stars/KyaniteLabs/Fugax.svg)](https://github.com/KyaniteLabs/Fugax/stargazers)
...
Fugax exposes an MCP server so any MCP-compatible AI assistant can use it directly:
...
**What is Fugax?**
Fugax is a companion tool for the OpenClaw ecosystem that transforms brain dump text into structured SOUL.md identity documents for AI agents.
...
**What LLM providers does Fugax support?**
Fugax works with any local LLM via Ollama (default: Gemma) or any OpenAI-compatible API (OpenAI, Anthropic via proxy, LM Studio, etc.). It falls back to template-based synthesis when no LLM is available.

**Can Fugax check cross-language risks?**
...
**Is Fugax free and open source?**
Yes. Fugax is MIT-licensed and uses zero external Python dependencies (stdlib only).

**What is the Soul Spec?**
Soul Spec is an open standard for AI agent personas. Fugax generates SOUL.md documents compatible with Soul Spec v0.5, OpenClaw, and any framework that reads markdown-based identity files.
