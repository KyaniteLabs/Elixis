...
def log_pipeline_start(brain_dump_length: int, request_id: Optional[str] = None):
    """Log pipeline start event."""
    logger = get_logger("soulcraft.pipeline")
    logger.info("Pipeline started", extra={
        "event_type": "pipeline_start",
        "brain_dump_length": brain_dump_length,
...
def log_llm_call(
    ...
    """Log LLM call event."""
    logger = get_logger("soulcraft.llm")
    extra = {
        "event_type": "llm_call",
        "model": model,
    ...
    if success:
        ...
        logger.error("LLM call failed", extra=extra)
...
def log_request(
    ...
    logger = get_logger("soulcraft.http")
