...
def synthesize_soulmd_stream(entities, graph, stage_timings=None):
    ...
    for event in chat_stream(messages):
        if event["type"] == "thinking":
            ...
            footer = f"> Generated by Fugax — {datetime.now().strftime('%Y-%m-%d')}\n> Built for OpenClaw-compatible AI agents"
            if "Generated by Fugax" not in result:
...
> Generated by Fugax — {datetime.now().strftime('%Y-%m-%d')}
> Built for OpenClaw-compatible AI agents
...
def _llm_synthesize(entities, graph):
    ...
    if content and len(content) > 200:
        ...
        footer = f"> Generated by Fugax — {datetime.now().strftime('%Y-%m-%d')}\n> Built for OpenClaw-compatible AI agents"
        if "Generated by Fugax" not in content:
